  ...
  <div class="etapas-page">
    ...
    <main v-else class="content-wrapper flex-grow-1">
      <div class="container-fluid py-4">
        <TituloSubtitulo
          titulo="⚙️ Etapas"
          subtitulo="Gerencie as etapas de produção cadastradas"
        />

        <button
          class="btn btn-success d-flex align-items-center gap-2 mb-4"
          @click="abrirModalNovaEtapa"
        >
        ...
        <div
          class="modal fade modal-nova-etapa"
          id="modalNovaEtapa"
          tabindex="-1"
          aria-labelledby="modalNovaEtapaLabel"
          aria-hidden="true"
        >
        ...
        <div
          ...
          id="modalEditarEtapa"
          tabindex="-1"
          aria-labelledby="modalEditarEtapaLabel"
          aria-hidden="true"
        >
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow-lg border-0 rounded-4">
              ...
              <div class="modal-body pt-3">
                ...
                <div class="mb-3">
                  ...
                  <input
                    v-model.number="etapaEdicao.tempo_padrao"
                    type="number"
                    class="form-control form-control-lg"
                    placeholder="Ex: 25"
                  />
        ...
        <div
          ...
          id="modalCronometro"
          tabindex="-1"
          aria-labelledby="modalCronometroLabel"
          aria-hidden="true"
        >
          <div class="modal-dialog modal-dialog-centered">
