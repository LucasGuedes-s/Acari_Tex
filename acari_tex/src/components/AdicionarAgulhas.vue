...
export default {
    ...
    methods: {
        async submitForm() {
            await axios.post("http://localhost:3333/AdicionarAgulha", {
                produto: {
                    valor: this.valor,
                    fornecedor: this.fornecedor,
                    numercao: this.numeracao,
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Agulha  Adicionada!',
                    text: 'Sua agulha foi adicionada com sucesso.',
                    timer: 2000,
