...
export declare function datamodelEnumToSchemaEnum(datamodelEnum: DMMF.DatamodelEnum): DMMF.SchemaEnum;
export declare namespace DMMF {
    ...
    type IndexType = 'id' | 'normal' | 'unique' | 'fulltext';
    type IndexField = ReadonlyDeep<{
        name: string;
        sortOrder?: SortOrder;
        length?: number;
